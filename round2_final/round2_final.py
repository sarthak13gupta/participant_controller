...
arm_4.setPosition(90.0*3.14159/180.0)
# arm_5.setPosition(45.0*3.14159/180.0)
 # -15.0 or 45.0
# arm_6.setPosition(90.0*3.14159/180.0)
...
class DynWallFoll:
    ...
    def check(self):
        ...
        print(self.distan(333),'distance for ray 333')
        self.dynamic_region()
